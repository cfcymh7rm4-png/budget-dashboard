...
import { pgTable, index, pgPolicy, uuid, varchar, numeric, uniqueIndex, date, customType } from "drizzle-orm/pg-core"
...
export const budget = pgTable("budget", {
  ...
  index("idx_budget_platform").using("btree", table.platform.asc().nullsLast().op("text_ops")),
  index("idx_budget_sku").using("btree", table.sku.asc().nullsLast().op("text_ops")),
